													...
													<td>{itemData.customers.customer_name}</td>
													{
														itemData.products.map(function(sub_itemData,j) {
															...
															<td key={sub_itemData.product_id}>
																	<input className="form-control text-right" type="number" value={sub_itemData.qty} onChange={this.setOnChangeQty.bind(this,i,j)} onBlur={this.setOnBlurQty.bind(this,i,j)} disabled />
															</td>
									...
									var out_sub_html = 
										<tr key={i}>
											<td className="text-center">
												<button className="btn-link btn-lg" type="button" onClick={this.editQty.bind(this,itemData.item_no)} disabled={!this.state.isSaveMasterData}><i className="fa-search-plus"></i></button>
											</td>
											{
												itemData.products.map(function(sub_itemData,j) {
